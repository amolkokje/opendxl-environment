...
The OpenDXL Environment is based on the [Centos operating system](https://www.centos.org/) and includes standard tools and libraries that are commonly used to develop and run OpenDXL solutions. The environment also includes a [web front-end](https://github.com/opendxl/opendxl-environment/wiki/Console-Overview) based on [Cloud Commander](http://cloudcmd.io/) that supports browser-based file management, file editing, and terminal access.
...
[https://hub.docker.com/r/amolkokje/opendxl-environment-centos/](https://hub.docker.com/r/amolkokje/opendxl-environment-centos/)
